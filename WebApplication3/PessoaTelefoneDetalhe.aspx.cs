    ...
    public partial class PessoaTelefoneDetalhe : System.Web.UI.Page
    {
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            if (txtTelefonePessoal.Text != "" || txtTelefoneRecado.Text != "" || txtTelefoneResidencial.Text!="")
            {
                ...
                _dados.TelefonePessoal = Convert.ToInt32(txtTelefonePessoal.Text);
                _dados.TelefoneRecado = Convert.ToInt32(txtTelefoneRecado.Text);
                _dados.TelefoneResidencial = Convert.ToInt32(txtTelefoneResidencial.Text);
